...
for i_crew in range(len(crews_to_process)):
	...
	print(crew_dir)
	this_matrix = pd.read_table(('gs://soteria_study_data/'+ crew_dir + '/Processing/eeg_pct_usable_matrix.csv'),delimiter=',')
...
fig.tight_layout()
# plt.show()
plt.savefig("Figures/" + 'total_eeg_available_matrix.jpg')
