	...
	for this_folder in range(trial_settings.shape[0]):
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/ABM.log'):
			...
			if not this_table.empty:
				...
				abm_leftseat.to_csv(crew_dir + "/Analysis/" + 'abm_leftseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/Emp_Emp_Device_Acc.log'):
			...
			if not this_table.empty:
				...
				emp_acc_leftseat.to_csv(crew_dir + "/Analysis/" + 'emp_acc_leftseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/Emp_Emp_Device_Bvp.log'):
			...
			if not this_table.empty:
				...
				emp_bvp_leftseat.to_csv(crew_dir + "/Analysis/" + 'emp_bvp_leftseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/Emp_Emp_Device_Gsr.log'):
			...
			if not this_table.empty:
				...
				emp_gsr_leftseat.to_csv(crew_dir + "/Analysis/" + 'emp_gsr_leftseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/Emp_Emp_Device_Ibi.log'):
			...
			if not this_table.empty:
				...
				emp_ibi_leftseat.to_csv(crew_dir + "/Analysis/" + 'emp_ibi_leftseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/Emp_Emp_Device_Temp.log'):
			...
			if not this_table.empty:
				...
				emp_temp_leftseat.to_csv(crew_dir + "/Analysis/" + 'emp_temp_leftseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/SmartEye_Left_Seat_ET.log'):
			...
			if not this_table.empty:
				...
				smarteye_leftseat.to_csv(crew_dir + "/Analysis/" + 'smarteye_leftseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/ABM-1.log'):
			...
			if not this_table.empty:
				...
				abm_rightseat.to_csv(crew_dir + "/Analysis/" + 'abm_rightseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/Emp_Emp_Device2_Acc.log'):
			...
			if not this_table.empty:
				...
				emp_acc_rightseat.to_csv(crew_dir + "/Analysis/" + 'emp_acc_rightseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/Emp_Emp_Device2_Bvp.log'):
			...
			if not this_table.empty:
				...
				emp_bvp_rightseat.to_csv(crew_dir + "/Analysis/" + 'emp_bvp_rightseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/Emp_Emp_Device2_Gsr.log'):
			...
			if not this_table.empty:
				...
				emp_gsr_rightseat.to_csv(crew_dir + "/Analysis/" + 'emp_gsr_rightseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/Emp_Emp_Device2_Ibi.log'):
			...
			if not this_table.empty:
				...
				emp_ibi_rightseat.to_csv(crew_dir + "/Analysis/" + 'emp_ibi_rightseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/Emp_Emp_Device2_Temp.log'):
			...
			if not this_table.empty:
				...
				emp_temp_rightseat.to_csv(crew_dir + "/Analysis/" + 'emp_temp_rightseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/SmartEye_Right_Seat_ET.log'):
			...
			if not this_table.empty:
				...
				smarteye_rightseat.to_csv(crew_dir + "/Analysis/" + 'smarteye_rightseat_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
		...
		if exists(crew_dir + "/Synched/" + str(trial_settings.RunDateTime[this_folder]) + '/IFD_COCKPIT.log'):
			...
			if not this_table.empty:
				...
				ifd_cockpit.to_csv(crew_dir + "/Analysis/" + 'ifd_cockpit_' + str(trial_settings.Scenario[this_folder])+'.csv',index=False)
